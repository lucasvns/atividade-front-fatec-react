        ...
        <div>
            ...
            <div className="container" id="adicionar-vacina">
                <form id="adicionar-vacina-form" onSubmit={handleAdicionarVacina}>
                    ...
                    <input type="text" name="nomevacina" value={vacina.nomevacina} onChange={(e) => { setVacina({ nomevacina: e.target.value }) }} placeholder="Nome da vacina" />
                    ...
                    <div className="modal">
                        <div className="modal-content">
                            ...
                            <form id="update-vacina-form" onSubmit={handleUpdateVacina}>
                                <label htmlFor="nomeUpdate">Nome da vacina</label>
                                <input type="text" id="nomeVacinaUpdate" name="nomeUpdate" placeholder="Nome da vacina" />
                                <button className="btn-full primary" type="submit">Atualizar</button>
                            </form>
                        </div>
